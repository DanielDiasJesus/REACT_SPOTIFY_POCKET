...
Antes de começar a desenvolver o projeto, primeiro é preciso criar uma conta de desenvolver no Spotify e registrar o aplicativo:
#### 1) Criar uma conta no Spotify
> Para utilizar a Web API, é necessário que ter uma conta de usuário (premium ou gratuita).
