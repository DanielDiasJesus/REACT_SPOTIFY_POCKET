# INSTADEV_REACT-SPA
Uma SPA (Single Page Application) mobile-first do Instagram em React.

## Objetivo:
O desafio foi desenvolver um *SPA (Single Page Application)* mobile-first do **Instagram** em React.

## Requisitos:
Trazer o que foi implementado anteriormente e cuidar dos estados dos componentes, das requsições HTTP de cada Rota da aplicação e dos ciclos de vida dos componentes utilizando React Hooks e abordagem funcional, os seguintes requisitos devem ser cumpridos:

> * Desenvolvido utilizando abordagem funcional e React Hooks para gerenciamento de ciclo de vida e estados.
...
A organização das pastas utiliza os seguintes padrões:
...
Seguindo estes dois padrões, a estrutura de arquivos e pastas do projeto deverá ficar exatamente assim (dentro de */src*:
...
## Tópicos:
Neste desafio foram tratado os conhecimentos em:
- **Fetch API**
- **JS Funcional:**
- **Modularização**
